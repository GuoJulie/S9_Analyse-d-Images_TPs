...
# Importing packages
from New_Tags import Colors, Scene_Main_Elements_1_2, ImgConvert, Main_Elements_1, Quality
...
def new_detect(file_path):
    ...
    new_keywords = list_1_colors + list_2_scene + list_3_ME1 + list_4_ME2 + list_5_quality
