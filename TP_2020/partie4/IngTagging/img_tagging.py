...
txt_color = Label(mainw, text =' Colors: yellow,green,red,blue,brown,gray,white,black,orange')
txt_scene = Label(mainw, text ='Scene: inside,outside,nature,city')
txt_inside = Label(mainw, text ='Content inside: human,face,animal,car,plane,van,byke,ski')
txt_outside = Label(mainw, text ='Content outside: sky,sun,house,tree,sea,water,mountain,snow')
txt_quality = Label(mainw, text ='Quality: fuzzy,sharp,dark,light')
txt_complexity = Label(mainw, text ='Complexity: isolated,multiple')
...
can1.grid(row =1, column =1,columnspan =3, rowspan =6, padx =10, pady =5)
...
txt_complexity.grid(row =6, column =4,sticky = W)

b_previous.grid(row =7, column =1)
b_update.grid(row =7, column =2)
b_next.grid(row =7, column =3)

txt_tag.grid(row =9, column =1)
boxkeywords.grid(row =9, columnspan =4, column =2)

txt_tag_1.grid(row =11, column =1)
boxkeywords_1.grid(row =11, columnspan =4, column =2)

b_gt.grid(row =12, column =1)
b_del.grid(row =12, column =2)
b_exit.grid(row =12, column =3)

txtseparator.grid(row =14, column =1, columnspan =4)
txtstatut.grid(row =14, columnspan =5, column =1,sticky = E)
